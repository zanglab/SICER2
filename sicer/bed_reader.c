...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [
            "sicer/shared/include/data_objects.h",
            "sicer/shared/include/removeAt.h"
        ],
        "extra_compile_args": [
            "-O3",
            "-ffast-math",
...
#include <string>
#include <stdint.h>
#include "include/data_objects.h"
#include <utility>
#include <map>
#include <vector>
#include "include/removeAt.h"
#include <algorithm>
#include <stdlib.h>
#include <stdio.h>
#ifdef _OPENMP
 ...
 * ctypedef char* cstr             # <<<<<<<<<<<<<<
 * 
 * cdef extern from "include/data_objects.h" nogil:
 */
