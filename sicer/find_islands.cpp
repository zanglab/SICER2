...
static int __Pyx_modinit_function_import_code(void) {
  ...
  if (__Pyx_ImportFunction(__pyx_t_1, "poisson", (void (**)(void))&__pyx_f_5sicer_7utility_5utils_poisson, "double (int, double)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
