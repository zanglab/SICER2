...
static int __pyx_f_5sicer_7utility_5utils_bin_tag_in_island(CYTHON_UNUSED std::vector<int>  &__pyx_v_island_starts, CYTHON_UNUSED std::vector<int>  &__pyx_v_island_ends, CYTHON_UNUSED int __pyx_v_tag_pos) {
  int __pyx_r;
