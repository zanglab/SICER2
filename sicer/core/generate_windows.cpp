...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "language": "c++",
        "name": "sicer.core.generate_windows",
        "sources": [
            "sicer/core/generate_windows.pyx"
        ]
    },
    "module_name": "sicer.core.generate_windows"
}
END: Cython Metadata */
...
#define __PYX_HAVE__sicer__core__generate_windows
#define __PYX_HAVE_API__sicer__core__generate_windows
/* Early includes */
#include <string.h>
#include "ios"
#include "new"
...
/* Module declarations from 'sicer.core.generate_windows' */
static std::vector<uint32_t>  __pyx_f_5sicer_4core_16generate_windows__get_tag_list(std::vector<BEDRead>  &, uint32_t, int); /*proto*/
static void __pyx_f_5sicer_4core_16generate_windows__generate_window_from_tags(std::vector<Window>  &, std::vector<uint32_t> , std::string, uint32_t, int); /*proto*/
static void __pyx_f_5sicer_4core_16generate_windows__generate_windows_by_chrom(std::vector<BEDRead>  &, std::vector<Window>  &, std::string, uint32_t, int, int); /*proto*/
static struct __pyx_obj_5sicer_6shared_10containers_WindowContainer *__pyx_f_5sicer_4core_16generate_windows__generate_windows(struct __pyx_obj_5sicer_6shared_10containers_BEDReadContainer *, PyObject *, int, int, int); /*proto*/
static struct __pyx_obj_5sicer_6shared_10containers_WindowContainer *__pyx_f_5sicer_4core_16generate_windows_generate_windows(PyObject *, PyObject *, PyObject *, PyObject *, PyObject *, int __pyx_skip_dispatch); /*proto*/
static std::string __pyx_convert_string_from_py_std__in_string(PyObject *); /*proto*/
static std::vector<std::string>  __pyx_convert_vector_from_py_std_3a__3a_string(PyObject *); /*proto*/
#define __Pyx_MODULE_NAME "sicer.core.generate_windows"
extern int __pyx_module_is_main_sicer__core__generate_windows;
int __pyx_module_is_main_sicer__core__generate_windows = 0;

/* Implementation of 'sicer.core.generate_windows' */
...
static const char __pyx_k_Window_count[] = "Window count: ";
static const char __pyx_k_chrom_length[] = "chrom_length";
static const char __pyx_k_cline_in_traceback[] = "cline_in_traceback";
static const char __pyx_k_Generating_windows_from_treateme[] = "Generating windows from treatement reads...";
static PyObject *__pyx_kp_u_Generating_windows_from_treateme;
static PyObject *__pyx_kp_u_Window_count;
...
static PyObject *__pyx_pf_5sicer_4core_16generate_windows_generate_windows(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_reads, PyObject *__pyx_v_genome_data, PyObject *__pyx_v_frag_size, PyObject *__pyx_v_window_size, PyObject *__pyx_v_num_cpu); /* proto */
static PyObject *__pyx_tuple_;
/* Late includes */

/* "sicer/core/generate_windows.pyx":18
 * 
 * 
...
static std::vector<uint32_t>  __pyx_f_5sicer_4core_16generate_windows__get_tag_list(std::vector<BEDRead>  &__pyx_v_reads, uint32_t __pyx_v_chrom_length, int __pyx_v_frag_size) {
  ...
  /* "sicer/core/generate_windows.pyx":20
 * cdef vector[uint32_t] _get_tag_list(vector[BEDRead]& reads, uint32_t chrom_length, int frag_size) nogil:
 *     cdef vector[uint32_t] tag_list
 *     cdef int shift = <int> round(frag_size / 2.0)             # <<<<<<<<<<<<<<
 *     cdef uint32_t pos
 ...
 */
  ...
  /* "sicer/core/generate_windows.pyx":23
 *     cdef uint32_t pos
 * 
 ...
 */
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    ...
    /* "sicer/core/generate_windows.pyx":24
 * 
 *     for i in range(reads.size()):
 *         read = reads[i]             # <<<<<<<<<<<<<<
 *         if read.start >= 0 and read.end < chrom_length:
 ...
 */
    ...
    /* "sicer/core/generate_windows.pyx":25
 *     for i in range(reads.size()):
 *         read = reads[i]
 *         if read.start >= 0 and read.end < chrom_length:             # <<<<<<<<<<<<<<
 *             if read.strand == b'+':
 ...
 */
    __pyx_t_5 = ((__pyx_v_read.start >= 0) != 0);
    if (__pyx_t_5) {
    } else {
      __pyx_t_4 = __pyx_t_5;
      goto __pyx_L6_bool_binop_done;
    }
    __pyx_t_5 = ((__pyx_v_read.end < __pyx_v_chrom_length) != 0);
    __pyx_t_4 = __pyx_t_5;
    __pyx_L6_bool_binop_done:;
    if (__pyx_t_4) {

      /* "sicer/core/generate_windows.pyx":26
 *         read = reads[i]
 *         if read.start >= 0 and read.end < chrom_length:
 *             if read.strand == b'+':             # <<<<<<<<<<<<<<
 *                 pos = read.start + shift
 ...
 */
      ...
      if (__pyx_t_4) {
        ...
        /* "sicer/core/generate_windows.pyx":27
 *         if read.start >= 0 and read.end < chrom_length:
 *             if read.strand == b'+':
 *                 pos = read.start + shift             # <<<<<<<<<<<<<<
 *                 if pos >= chrom_length:
 ...
 */
        ...
        /* "sicer/core/generate_windows.pyx":28
 *             if read.strand == b'+':
 *                 pos = read.start + shift
 *                 if pos >= chrom_length:             # <<<<<<<<<<<<<<
 *                     pos = chrom_length - 1
 ...
 */
        ...
        if (__pyx_t_4) {
          ...
          /* "sicer/core/generate_windows.pyx":29
 *                 pos = read.start + shift
 *                 if pos >= chrom_length:
 *                     pos = chrom_length - 1             # <<<<<<<<<<<<<<
 *             else:
 ...
 */
      ...
      /* "sicer/core/generate_windows.pyx":31
 *                     pos = chrom_length - 1
 *             else:
 *                 pos = read.end - shift - 1             # <<<<<<<<<<<<<<
 *                 if pos < 0:
 ...
 */
      /*else*/ {
        ...
        /* "sicer/core/generate_windows.pyx":32
 *             else:
 *                 pos = read.end - shift - 1
 *                 if pos < 0:             # <<<<<<<<<<<<<<
 *                     pos = 0
 ...
 */
        ...
        if (__pyx_t_4) {
          ...
          /* "sicer/core/generate_windows.pyx":33
 *                 pos = read.end - shift - 1
 *                 if pos < 0:
 *                     pos = 0             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      /* "sicer/core/generate_windows.pyx":35
 *                     pos = 0
 * 
 *             tag_list.push_back(pos)             # <<<<<<<<<<<<<<
 * 
 ...
 */
      try {
        __pyx_v_tag_list.push_back(__pyx_v_pos);
      } catch(...) {
        #ifdef WITH_THREAD
 ...
 */
  ...
  /* "sicer/core/generate_windows.pyx":37
 *             tag_list.push_back(pos)
 * 
 *     sort(tag_list.begin(), tag_list.end())             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "sicer/core/generate_windows.pyx":39
 *     sort(tag_list.begin(), tag_list.end())
 * 
 *     return tag_list             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* function exit code */
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("sicer.core.generate_windows._get_tag_list", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 1);
  __Pyx_pretend_to_initialize(&__pyx_r);
  __pyx_L0:;
  return __pyx_r;
}

/* "sicer/core/generate_windows.pyx":41
 *     return tag_list
 * 
 * cdef void _generate_window_from_tags(             # <<<<<<<<<<<<<<
...
static void __pyx_f_5sicer_4core_16generate_windows__generate_window_from_tags(std::vector<Window>  &__pyx_v_windows, std::vector<uint32_t>  __pyx_v_tag_list, std::string __pyx_v_chrom, uint32_t __pyx_v_chrom_length, int __pyx_v_window_size) {
  ...
  /* "sicer/core/generate_windows.pyx":54
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "sicer/core/generate_windows.pyx":55
 * 
 *     if tag_list.size() > 0:
 *         curr_win_start = (tag_list[0] // window_size) * window_size             # <<<<<<<<<<<<<<
 *         curr_tag_count = 1
 ...
 */
    ...
    /* "sicer/core/generate_windows.pyx":56
 *     if tag_list.size() > 0:
 *         curr_win_start = (tag_list[0] // window_size) * window_size
 *         curr_tag_count = 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "sicer/core/generate_windows.pyx":58
 *         curr_tag_count = 1
 * 
 *         if tag_list.size() > 1:             # <<<<<<<<<<<<<<
 ...
 */
    ...
    if (__pyx_t_1) {
      ...
      /* "sicer/core/generate_windows.pyx":59
 * 
 *         if tag_list.size() > 1:
 *             for i in range(1, tag_list.size()):             # <<<<<<<<<<<<<<
 *                 adjusted_tag_pos = (tag_list[i] // window_size) * window_size
 ...
 */
      __pyx_t_3 = __pyx_v_tag_list.size();
      __pyx_t_4 = __pyx_t_3;
      for (__pyx_t_5 = 1; __pyx_t_5 < __pyx_t_4; __pyx_t_5+=1) {
        __pyx_v_i = __pyx_t_5;

        /* "sicer/core/generate_windows.pyx":60
 *         if tag_list.size() > 1:
 *             for i in range(1, tag_list.size()):
 *                 adjusted_tag_pos = (tag_list[i] // window_size) * window_size             # <<<<<<<<<<<<<<
 *                 if adjusted_tag_pos == curr_win_start:
 ...
 */
        __pyx_t_2 = (__pyx_v_tag_list[__pyx_v_i]);
        if (unlikely(__pyx_v_window_size == 0)) {
          #ifdef WITH_THREAD
          PyGILState_STATE __pyx_gilstate_save = __Pyx_PyGILState_Ensure();
          #endif
        ...
        __pyx_v_adjusted_tag_pos = ((__pyx_t_2 / __pyx_v_window_size) * __pyx_v_window_size);

        /* "sicer/core/generate_windows.pyx":61
 *             for i in range(1, tag_list.size()):
 *                 adjusted_tag_pos = (tag_list[i] // window_size) * window_size
 *                 if adjusted_tag_pos == curr_win_start:             # <<<<<<<<<<<<<<
 *                     preinc(curr_tag_count)
 ...
 */
        ...
        if (__pyx_t_1) {
          ...
          /* "sicer/core/generate_windows.pyx":62
 *                 adjusted_tag_pos = (tag_list[i] // window_size) * window_size
 *                 if adjusted_tag_pos == curr_win_start:
 *                     preinc(curr_tag_count)             # <<<<<<<<<<<<<<
 *                 elif adjusted_tag_pos > curr_win_start:
 ...
 */
        ...
        /* "sicer/core/generate_windows.pyx":63
 *                 if adjusted_tag_pos == curr_win_start:
 *                     preinc(curr_tag_count)
 *                 elif adjusted_tag_pos > curr_win_start:             # <<<<<<<<<<<<<<
 *                     curr_win_end = curr_win_start + window_size - 1
 ...
 */
        ...
        if (__pyx_t_1) {
          ...
          /* "sicer/core/generate_windows.pyx":64
 *                     preinc(curr_tag_count)
 *                 elif adjusted_tag_pos > curr_win_start:
 *                     curr_win_end = curr_win_start + window_size - 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
          ...
          /* "sicer/core/generate_windows.pyx":66
 *                     curr_win_end = curr_win_start + window_size - 1
 * 
 *                     if curr_win_end < chrom_length:             # <<<<<<<<<<<<<<
 *                         # Create new window
 ...
 */
          ...
          if (__pyx_t_1) {
            ...
            /* "sicer/core/generate_windows.pyx":68
 *                     if curr_win_end < chrom_length:
 *                         # Create new window
 *                         windows.push_back(Window(             # <<<<<<<<<<<<<<
 *                             chrom,
 ...
 */
            try {
              __pyx_v_windows.push_back(Window(__pyx_v_chrom, __pyx_v_curr_win_start, __pyx_v_curr_win_end, __pyx_v_curr_tag_count));
            } catch(...) {
              #ifdef WITH_THREAD
              PyGILState_STATE __pyx_gilstate_save = __Pyx_PyGILState_Ensure();
              #endif
 ...
 */
          ...
          /* "sicer/core/generate_windows.pyx":75
 *                         ))
 * 
 ...
 */
          ...
          /* "sicer/core/generate_windows.pyx":76
 * 
 *                     curr_win_start = adjusted_tag_pos
 *                     curr_tag_count = 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "sicer/core/generate_windows.pyx":78
 *                     curr_tag_count = 1
 * 
 *         curr_win_end = curr_win_start + window_size - 1             # <<<<<<<<<<<<<<
 *         if curr_win_end < chrom_length:
 ...
 */
    ...
    /* "sicer/core/generate_windows.pyx":79
 * 
 *         curr_win_end = curr_win_start + window_size - 1
 *         if curr_win_end < chrom_length:             # <<<<<<<<<<<<<<
 *             windows.push_back(Window(
 ...
 */
    ...
    if (__pyx_t_1) {
      ...
      /* "sicer/core/generate_windows.pyx":80
 *         curr_win_end = curr_win_start + window_size - 1
 *         if curr_win_end < chrom_length:
 *             windows.push_back(Window(             # <<<<<<<<<<<<<<
 *                 chrom,
 ...
 */
  ...
  goto __pyx_L0;
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("sicer.core.generate_windows._generate_window_from_tags", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 1);
  __pyx_L0:;
}

/* "sicer/core/generate_windows.pyx":87
 *             ))
 * 
...
static void __pyx_f_5sicer_4core_16generate_windows__generate_windows_by_chrom(std::vector<BEDRead>  &__pyx_v_reads, std::vector<Window>  &__pyx_v_windows, std::string __pyx_v_chrom, uint32_t __pyx_v_chrom_length, int __pyx_v_frag_size, int __pyx_v_window_size) {
  std::vector<uint32_t>  __pyx_v_tag_list;
  int __pyx_t_1;

  /* "sicer/core/generate_windows.pyx":96
 * ) nogil:
 *     cdef vector[uint32_t] tag_list
 *     if reads.size() > 0:             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "sicer/core/generate_windows.pyx":97
 *     cdef vector[uint32_t] tag_list
 *     if reads.size() > 0:
 *         tag_list = _get_tag_list(reads, chrom_length, frag_size)             # <<<<<<<<<<<<<<
 *         _generate_window_from_tags(windows, tag_list, chrom, chrom_length, window_size)
 * 
 */
    __pyx_v_tag_list = __pyx_f_5sicer_4core_16generate_windows__get_tag_list(__pyx_v_reads, __pyx_v_chrom_length, __pyx_v_frag_size);

    /* "sicer/core/generate_windows.pyx":98
 *     if reads.size() > 0:
 *         tag_list = _get_tag_list(reads, chrom_length, frag_size)
 *         _generate_window_from_tags(windows, tag_list, chrom, chrom_length, window_size)             # <<<<<<<<<<<<<<
 * 
 ...
 */
    __pyx_f_5sicer_4core_16generate_windows__generate_window_from_tags(__pyx_v_windows, __pyx_v_tag_list, __pyx_v_chrom, __pyx_v_chrom_length, __pyx_v_window_size);
...
/* "sicer/core/generate_windows.pyx":100
 *         _generate_window_from_tags(windows, tag_list, chrom, chrom_length, window_size)
 * 
 * cdef WindowContainer _generate_windows(             # <<<<<<<<<<<<<<
...
static struct __pyx_obj_5sicer_6shared_10containers_WindowContainer *__pyx_f_5sicer_4core_16generate_windows__generate_windows(struct __pyx_obj_5sicer_6shared_10containers_BEDReadContainer *__pyx_v_reads, PyObject *__pyx_v_genome_data, int __pyx_v_frag_size, int __pyx_v_window_size, CYTHON_UNUSED int __pyx_v_num_cpu) {
  ...
  int __pyx_v_i;
  struct __pyx_obj_5sicer_6shared_10containers_WindowContainer *__pyx_r = NULL;
  ...
  /* "sicer/core/generate_windows.pyx":108
 * ):
 ...
 */
  __pyx_t_1 = ((struct __pyx_vtabstruct_5sicer_6shared_10containers_BEDReadContainer *)__pyx_v_reads->__pyx_vtab)->getChromosomes(__pyx_v_reads, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 108, __pyx_L1_error)
  ...
  /* "sicer/core/generate_windows.pyx":110
 *     cdef vector[string] chroms = reads.getChromosomes()
 *     cdef vector[uint32_t] chrom_lengths
 *     for c in genome_data.chrom:             # <<<<<<<<<<<<<<
 ...
 */
  ...
  for (;;) {
    ...
    /* "sicer/core/generate_windows.pyx":111
 *     cdef vector[uint32_t] chrom_lengths
 *     for c in genome_data.chrom:
 *         chrom_lengths.push_back(genome_data.chrom_length[c])             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "sicer/core/generate_windows.pyx":113
 *         chrom_lengths.push_back(genome_data.chrom_length[c])
 * 
 *     cdef WindowContainer windows = WindowContainer(genome_data)             # <<<<<<<<<<<<<<
 * 
 *     cdef int i
 */
  __pyx_t_3 = __Pyx_PyObject_CallOneArg(((PyObject *)__pyx_ptype_5sicer_6shared_10containers_WindowContainer), __pyx_v_genome_data); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 113, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_v_windows = ((struct __pyx_obj_5sicer_6shared_10containers_WindowContainer *)__pyx_t_3);
  __pyx_t_3 = 0;

  /* "sicer/core/generate_windows.pyx":116
 * 
 *     cdef int i
 ...
 */
  {
      ...
      /*try:*/ {
        ...
        if (1 == 0) abort();
        {
            ...
            {
                #ifdef _OPENMP
                #pragma omp parallel num_threads(__pyx_v_num_cpu) private(__pyx_t_11, __pyx_t_12) private(__pyx_filename, __pyx_lineno, __pyx_clineno) shared(__pyx_parallel_why, __pyx_parallel_exc_type, __pyx_parallel_exc_value, __pyx_parallel_exc_tb)
                #endif /* _OPENMP */
                {
                    #ifdef _OPENMP
                    #ifdef WITH_THREAD
                    ...
                    for (__pyx_t_9 = 0; __pyx_t_9 < __pyx_t_10; __pyx_t_9++){
                        if (__pyx_parallel_why < 2)
                        {
                            ...
                            /* "sicer/core/generate_windows.pyx":118
 *     for i in prange(chroms.size(), schedule='guided', num_threads=num_cpu, nogil=True):
 *         _generate_windows_by_chrom(
 *             deref(reads.getVectorPtr(chroms.at(i))),             # <<<<<<<<<<<<<<
 ...
 */
                            ...
                            /* "sicer/core/generate_windows.pyx":119
 *         _generate_windows_by_chrom(
 *             deref(reads.getVectorPtr(chroms.at(i))),
 *             deref(windows.getVectorPtr(chroms.at(i))),             # <<<<<<<<<<<<<<
 *             chroms[i],
 ...
 */
                            try {
                              __pyx_t_12 = __pyx_v_chroms.at(__pyx_v_i);
                            } catch(...) {
                              #ifdef WITH_THREAD
                              PyGILState_STATE __pyx_gilstate_save = __Pyx_PyGILState_Ensure();
                              #endif
                            ...
                            /* "sicer/core/generate_windows.pyx":117
 *     cdef int i
 *     for i in prange(chroms.size(), schedule='guided', num_threads=num_cpu, nogil=True):
 *         _generate_windows_by_chrom(             # <<<<<<<<<<<<<<
 *             deref(reads.getVectorPtr(chroms.at(i))),
 *             deref(windows.getVectorPtr(chroms.at(i))),
 */
                            __pyx_f_5sicer_4core_16generate_windows__generate_windows_by_chrom((*((struct __pyx_vtabstruct_5sicer_6shared_10containers_BEDReadContainer *)__pyx_v_reads->__pyx_vtab)->getVectorPtr(__pyx_v_reads, __pyx_t_11)), (*((struct __pyx_vtabstruct_5sicer_6shared_10containers_WindowContainer *)__pyx_v_windows->__pyx_vtab)->getVectorPtr(__pyx_v_windows, __pyx_t_12)), (__pyx_v_chroms[__pyx_v_i]), (__pyx_v_chrom_lengths[__pyx_v_i]), __pyx_v_frag_size, __pyx_v_window_size);
                            goto __pyx_L13;
                            __pyx_L10_error:;
                            {
                                #ifdef WITH_THREAD
 ...
 */
  ...
  /* "sicer/core/generate_windows.pyx":126
 *         )
 * 
 ...
 * 
 */
  ((struct __pyx_vtabstruct_5sicer_6shared_10containers_WindowContainer *)__pyx_v_windows->__pyx_vtab)->updateCounts(__pyx_v_windows, 0);

  /* "sicer/core/generate_windows.pyx":127
 * 
 *     windows.updateCounts()
 *     print("Window count: ", windows.getWindowCount())             # <<<<<<<<<<<<<<
 * 
 *     return windows
 */
  __pyx_t_3 = __Pyx_PyInt_From_uint32_t(((struct __pyx_vtabstruct_5sicer_6shared_10containers_WindowContainer *)__pyx_v_windows->__pyx_vtab)->getWindowCount(__pyx_v_windows, 0)); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 127, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  ...
  PyTuple_SET_ITEM(__pyx_t_6, 0, __pyx_kp_u_Window_count);
  ...
  /* "sicer/core/generate_windows.pyx":129
 *     print("Window count: ", windows.getWindowCount())
 * 
 *     return windows             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_AddTraceback("sicer.core.generate_windows._generate_windows", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
...
/* "sicer/core/generate_windows.pyx":131
 *     return windows
 * 
 * cpdef WindowContainer generate_windows(reads, genome_data, frag_size, window_size, num_cpu):             # <<<<<<<<<<<<<<
...
static PyObject *__pyx_pw_5sicer_4core_16generate_windows_1generate_windows(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static struct __pyx_obj_5sicer_6shared_10containers_WindowContainer *__pyx_f_5sicer_4core_16generate_windows_generate_windows(PyObject *__pyx_v_reads, PyObject *__pyx_v_genome_data, PyObject *__pyx_v_frag_size, PyObject *__pyx_v_window_size, PyObject *__pyx_v_num_cpu, CYTHON_UNUSED int __pyx_skip_dispatch) {
  struct __pyx_obj_5sicer_6shared_10containers_WindowContainer *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_t_2;
  ...
  /* "sicer/core/generate_windows.pyx":132
 * 
 * cpdef WindowContainer generate_windows(reads, genome_data, frag_size, window_size, num_cpu):
 *     print("Generating windows from treatement reads...")             # <<<<<<<<<<<<<<
 *     return _generate_windows(reads, genome_data, frag_size, window_size, num_cpu)
 ...
 */
  ...
  /* "sicer/core/generate_windows.pyx":133
 * cpdef WindowContainer generate_windows(reads, genome_data, frag_size, window_size, num_cpu):
 *     print("Generating windows from treatement reads...")
 *     return _generate_windows(reads, genome_data, frag_size, window_size, num_cpu)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __Pyx_XDECREF(((PyObject *)__pyx_r));
  if (!(likely(((__pyx_v_reads) == Py_None) || likely(__Pyx_TypeTest(__pyx_v_reads, __pyx_ptype_5sicer_6shared_10containers_BEDReadContainer))))) __PYX_ERR(0, 133, __pyx_L1_error)
  ...
  __pyx_t_1 = ((PyObject *)__pyx_f_5sicer_4core_16generate_windows__generate_windows(((struct __pyx_obj_5sicer_6shared_10containers_BEDReadContainer *)__pyx_v_reads), __pyx_v_genome_data, __pyx_t_2, __pyx_t_3, __pyx_t_4)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 133, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = ((struct __pyx_obj_5sicer_6shared_10containers_WindowContainer *)__pyx_t_1);
  __pyx_t_1 = 0;
  goto __pyx_L0;
 ...
 */
  ...
  __pyx_L1_error:;
  __Pyx_XDECREF(__pyx_t_1);
  __Pyx_AddTraceback("sicer.core.generate_windows.generate_windows", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_XGIVEREF((PyObject *)__pyx_r);
  __Pyx_RefNannyFinishContext();
...
/* Python wrapper */
static PyObject *__pyx_pw_5sicer_4core_16generate_windows_1generate_windows(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_5sicer_4core_16generate_windows_1generate_windows(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("generate_windows (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_reads,&__pyx_n_s_genome_data,&__pyx_n_s_frag_size,&__pyx_n_s_window_size,&__pyx_n_s_num_cpu,0};
    ...
    __pyx_v_frag_size = values[2];
    __pyx_v_window_size = values[3];
    __pyx_v_num_cpu = values[4];
  }
  ...
  __pyx_r = __pyx_pf_5sicer_4core_16generate_windows_generate_windows(__pyx_self, __pyx_v_reads, __pyx_v_genome_data, __pyx_v_frag_size, __pyx_v_window_size, __pyx_v_num_cpu);
...
static PyObject *__pyx_pf_5sicer_4core_16generate_windows_generate_windows(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_reads, PyObject *__pyx_v_genome_data, PyObject *__pyx_v_frag_size, PyObject *__pyx_v_window_size, PyObject *__pyx_v_num_cpu) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannySetupContext("generate_windows", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = ((PyObject *)__pyx_f_5sicer_4core_16generate_windows_generate_windows(__pyx_v_reads, __pyx_v_genome_data, __pyx_v_frag_size, __pyx_v_window_size, __pyx_v_num_cpu, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 131, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static PyMethodDef __pyx_methods[] = {
  {"generate_windows", (PyCFunction)__pyx_pw_5sicer_4core_16generate_windows_1generate_windows, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec_generate_windows(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_generate_windows},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  {&__pyx_kp_u_Generating_windows_from_treateme, __pyx_k_Generating_windows_from_treateme, sizeof(__pyx_k_Generating_windows_from_treateme), 0, 1, 0, 0},
  {&__pyx_kp_u_Window_count, __pyx_k_Window_count, sizeof(__pyx_k_Window_count), 0, 1, 0, 0},
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initgenerate_windows(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initgenerate_windows(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_generate_windows(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_generate_windows(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static int __pyx_pymod_exec_generate_windows(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_generate_windows(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("generate_windows", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_sicer__core__generate_windows) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "sicer.core.generate_windows")) {
      if (unlikely(PyDict_SetItemString(modules, "sicer.core.generate_windows", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "sicer/core/generate_windows.pyx":1
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init sicer.core.generate_windows", 0, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init sicer.core.generate_windows");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
